...
public class SiswaIPSKelas2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_siswa_ips_kelas2);
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Daftar_siswa").child("Kelas 2").child("IPS");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : snapshot.getChildren()) {
                    ...
                    list.add(model);
                    AdapterDaftarSiswa adapter = new AdapterDaftarSiswa(list, SiswaIPSKelas2.this);
                    RecyclerView.LayoutManager layoutManager = new GridLayoutManager(SiswaIPSKelas2.this, 1);
