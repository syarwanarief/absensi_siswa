...
public class SiswaIPAKelas1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_siswa_kelas1);
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Daftar_siswa").child("Kelas 1").child("IPA");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : snapshot.getChildren()) {
                    ...
                    list.add(model);
                    AdapterDaftarSiswa adapter = new AdapterDaftarSiswa(list, SiswaIPAKelas1.this);
                    RecyclerView.LayoutManager layoutManager = new GridLayoutManager(SiswaIPAKelas1.this, 1);
